...
//            MsmLog.print("myvpn --- acquire :" + Integer.toHexString(System.identityHashCode(buffer)));
//        }
...
//        MsmLog.print("myvpn --- release :" + Integer.toHexString(System.identityHashCode(buffer)));
    }
